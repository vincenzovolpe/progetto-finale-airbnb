        ...
        <div class="col-lg-6">
            <form id="create" method="POST" action="{{ route('upr.flats.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="title" class="col-sm-3 col-form-label text-md-left">{{ __('create.Description') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label text-md-left tt-address-label">{{ __('create.Address') }}</label>
                    <div class="col-sm-9">
